...
Провести четыре эксперимента по обработке большого датасета с использованием Hadoop (HDFS) и Apache Spark, чтобы сравнить производительность базового и оптимизированного Spark-приложения   на кластерах с 1 и 3 DataNode.
